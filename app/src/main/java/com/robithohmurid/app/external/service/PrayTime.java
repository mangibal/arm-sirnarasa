...
public class PrayTime {
    ...
    public int KEMENAG; // Kementerian Agama RI
    // Juristic Methods
    ...
    public PrayTime() {
        ...
        // Custom
        double[] Cvalues = {20.0, 0, 0, 0, 18.0};
        methodParams.put(Integer.valueOf(this.getCustom()), Cvalues);

        // KEMENAG
        double[] KRIvalues = {20.0, 0, 0, 0, 18.0};
        methodParams.put(Integer.valueOf(this.getKemenag()), KRIvalues);
    }
    ...
    public static void main(String[] args) {
        double latitude = -6.8913427;
        double longitude = 107.5807468;
        double timezone = 7;
        ...
        int[] offsets = {2, 3, 2, 2, 2, 2, 2}; // { Fajr,Sunrise,Dhuhr,Asr,Sunset,Maghrib,Isha }
    ...
    private void setKemenag(int kemenag) {
        KEMENAG = kemenag;
    }

    private int getKemenag() {
        return KEMENAG;
    }
