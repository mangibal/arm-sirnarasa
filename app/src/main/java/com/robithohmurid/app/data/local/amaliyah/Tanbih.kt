...
/**
 * Created by Iqbal Fauzi on 28/09/21 20.31
 * iqbal.fauzi.if99@gmail.com
 */
val tanbihData = ListingEntity(0, "Tanbih","""
**TANBIH**
...
Pun pula semoga Pimpinan Negara bertambah kemuliaan dan keagungannya supaya dapat melindungi dan membimbing seluruh rakyat dalam keadaan aman, adil dan makmur zhohir dan bathin.
...
_'Sangat Kami mulyakan keturunan Adam dan Kami sebarkan segala yang berada di darat dan di lautan, Kami berikan mereka rezeki yang baik-baik dan juga Kami mengutamakan mereka lebih utama dari makhluk lainnya'._
...
_'Hendaklah tolong menolong dengan sesama dalam melaksanakan kebajikan dan ketaqwaan dengan sungguh-sungguh terhadap AGAMA dan NEGARA, sebaliknya janganlah tolong-menolong dalam berbuat dosa dan permusuhan terhadap perintah AGAMA dan NEGARA "._

Adapun soal keagamaan, itu terserah agamanya masing-masing, mengingat Suroh Al-Kafirun ayat 6 :

_'Agamamu Untuk Kamu, Agamaku Untuk Aku'_
...
_'Hendaklah kita bersikap budiman, tertib dan damai. Andaikan tidak demikian, pasti sesal dahulu pendapatan, sesal kemudian tak berguna'_
...
_'Tuhan yang Maha Esa telah memberikan contoh, yakni tempat maupun kampung, desa maupun negara yang dahulunya aman dan tenteram, gemah ripah loh jinawi, namun penduduknya/ penghuninya mengingkari nikmat-nikmat Alloh, maka lalu berkecamuklah bencana kelaparan, penderitaan dan ketakutan yang disebabkan sikap dan perbuatan mereka sendiri'._
...
_'Budi Utama ' Jasmani Sempurna'_
...
val tanbihSundaData = ListingEntity(0, "Tanbih","""
    اِلٰى حَضْرَةِ الشَّيْخِ عَبْدُ اللّٰهِ مُبَارَكْ بِنْ نُوْر مُحَمَّدْ ، اَلْفَـاتـِحَةَ

    _Ilaa Hadhrotis Syaikh Abdulloh Mubarok bin Nur Muhammad QS wa RA, Al Fatihah_
    ...
    **TANBIH**
    ...
    Oge nu jadi Papayung Nagara sina tambih kamulyaanana, kaagunganana tiasa nangtayungan ka sadaya abdi-abdina, ngauban ka sadaya rakyatna dipaparin karaharjaan, kajembaran, kani'matan ku Gusti nu Maha Suci, dlohir-bathin.

    Jeungna sim kuring nu jadi pananyaan  _Thariqah Qadiriyah Naqsabandiyah Pondok Pesantren Suryalaya_, ngahaturkeun kagegelan wasiat ka sadaya murid-murid poma sing hade-hade dina sagala laku lampah, ulah aya carekeun AGAMA jeung NAGARA.
    ...
    **Kaopat :** Kanu pakir jeung miskin kudu welas asih, someah, tur budi beresih, sarta daek mere maweh, ngayatakeun hate urang sareh. Geura rasakeun awak urang sorangan kacida ngerikna ati ari dina kakurangan. Anu matak ulah rek kajongjonan ngeunah dewek henteu lian, da pakir miskin teh lain kahayangna sorangan, estu kadaring Pangeran.
    ...
    Tah kitu pigeusaneun manusa anu pinuh karumasaan, sanajan jeung sejen bangsa, sabab tungal turunan ti Nabi Adam AS. numutkeun ayat 70 surat Isro anu pisundaeunana kieu:

    '_Kacida ngamulyakeunana Kami ka turunan Adam, jeung Kami nyebarkeun sakabeh daratan oge lautan, jeung ngarijkian Kami ka maranehanana, anu aya di darat jeung lautan, jeung Kami ngutamakeun ka maranehanana, malah leuwih utama ti mahkluk anu sejenna._'

    Jadi harti ieu ayat nyaeta akur jeung batur-batur ulah aya kuciwana, nurutkeun ayat tina surat Al-Ma'idah anu sundana.

    '_Kudu silih tulungan jeung batur-batur dina enggoning kahadean jeung katakwaan terhadep AGAMA jeung NAGARA, soson-soson ngalampahkeunana, sabalikna ulah silih tulungan kana jalan perdosaan jeung permusuhan terhadep parentah agama jeung nagara_.'

    Ari sebagi agama, saagamana-saagamana, nurutkeun surat Al-Kafirun ayat 6:

    _'Agama anjeun keur anjeun, agama kuring keur kuring'_, surahna ulah jadi papaseaan 'kudu akur jeung batur-batur tapi ulah campur baur'.

    Geuning dawuhan sepuh baheula:  _'Sina logor dina liang jarum, ulah sereg di buana'_.

    Lamun urangna henteu kitu tangtu hanjakal diakhirna. Karana anu matak tugeunah terhadep badan urang masing-masing eta teh tapak amal perbuatanana. Dina surat An- Nahli ayat 112 diunggelkeun anu kieu:

    '_Gusti Alloh geus maparing conto pirang-pirang tempat, boh kampungna atawa desana atawa nagarana, anu dina eta tempat nuju aman sentosa, gemah ripah loh jinawi, kari-kari pendudukna (nu nyicinganana) teu narima kana ni'mat ti Pangeran, maka tuluy bae dina eta tempat kalaparan, loba kasusah, loba karisi jeung sajabana, kitu teh samata-mata pagawean maranehanana_'.
    ...
    **(Syaikh Ahmad Shihibul Wafa Tajul Arifin QS. R.A )**
    Ilaa Hadlroti Syaikh Ahmad Shohibulwafa Tajul 'Arifin Qoddasallohu Sirrohu Warodhiyallohu Anhu Alfatihah
    ...
    **Bil Barokah Wal Karomah Mursyid Fii Hadza Zaman Syekh  Muhammad Abdul Gaos Saefulloh Maslul al-Qodiri, al-Kamil, an-Naqsyabandi, al-Muttaqi,  al-Muwaffaq,  al-Mujadid, al Quthub, as-Shomadany, al-Mahdi, Qoddasalloohu Sirrohu Al Fatihah.**
""".trimIndent())