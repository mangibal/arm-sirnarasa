package com.robithohmurid.app.data.local.amaliyah.manaqib.manqobah

import com.robithohmurid.app.data.model.entity.ListingEntity

val muqodimahData = ListingEntity(0, "Muqodimah","""
    **MUQODIMAH MANQOBAH**
    ...
    *YAA MUJLIYAL KALAAMIL QODIMI*  
    (Artinya: Wahai yang menyingkap Kalam Al Qodim)  
    *YAA SYIFAAA ASQOOMIS SAQIIMI*  
    (Artinya: Wahai penyembuh penyakit orang yang sakit)  
