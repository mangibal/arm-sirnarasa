...
import com.robithohmurid.app.data.local.ServicesEntity
...
class ServicesAdapter :
    BaseAdapter<ServicesEntity, ItemGridMenuBinding, ServicesAdapter.ItemHolder>(
    ...
    inner class ItemHolder(private val binding: ItemGridMenuBinding) :
        BaseHolder<ServicesEntity>(binding) {

        override fun bind(data: ServicesEntity) {
            with(binding) {
